...
function Homepage() {
   ...
   const handleDelete = async (blogId) => {
      try {
         await axios.delete(`http://localhost:8000/home/delete/${blogId}`);
   ...
   const handleCreateOrUpdate = async () => {
      try {
         if (isEditMode) {
            await axios.put(`http://localhost:8000/home/update/${editId}`, formData);
         } else {
            await axios.post("http://localhost:8000/home/createHomePage", formData);
         }
